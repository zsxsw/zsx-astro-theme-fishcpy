...
```
    /*  基础设置 */
    <script>
        window.CustomLogo = "https://cdn.fishcpy.top/img/2025/05/29/683836588877f.webp";  /*  自定义logo */
    ...
    /* 以上鼠标特效 */
    <script>
    window.CustomBackgroundImage="https://cdn.fishcpy.top/img/2025/05/05/68182abdc7d6e.png"; /* 背景图 */
    </script>
